from abstra_notas.nfse.ce.fortaleza import ConsultarNfsePorRpsEnvio, TipoRps
...
try:
    ...
    if resposta.comp_nfse:
        ...
        if resposta.comp_nfse.cancelamento and resposta.comp_nfse.cancelamento.sucesso:
            print(f"   Status: CANCELADA em {resposta.comp_nfse.cancelamento.data_hora}")
        else:
